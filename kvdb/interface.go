...
we thought to replace map structure with []byte structure, but for extensions, we think the map is well,
the map is a stable structure. think about some scenario of only take part of the secrets, we can easy handle with it.
*/
type KVer interface {
